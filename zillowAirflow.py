...
with DAG('zillow_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_zillow_data_var")[0]}} s3://endtoend-pipeline-aws-bucket/',
        )
        ...
        bucket_name='cleaned-data-zone-csv',
        ...
        s3_bucket='cleaned-data-zone-csv',
